...
class Exercice10
{
	...
	static void Main()
	{
		...
		{
			int indice_insertion_valeur = IndiceInsertionPartiellementTrie(tab, 5, valeur);
			AfficherChaine("La valeur " + valeur + " est à insérer à l'indice " + indice_insertion_valeur + ".");
		}
	}
}
