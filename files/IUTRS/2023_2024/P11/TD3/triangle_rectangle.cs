...
class TriangleRectangle
{
    ...
    // Fonction : calcule et affiche un triangle rectangle
    // composé d'étoiles de hauteur h dans le terminal
    // Paramètres :
    //  - h (int): hauteur du triangle
    // Retourne : /
    public static void AfficherTriangleRectangle(int h)
    {
        ...
        for (int ligne = 0; ligne < h; ligne++)
        {
            ...
            string chaine = GenererRepetition(nbEtoiles, "*");
            //  - afficher la chaîne dans le terminal
    ...
    static void Main()
    {
        ...
        AfficherTriangleRectangle(hauteur);
    }
}