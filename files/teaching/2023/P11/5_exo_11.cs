...
class Exercice11
{
	...
	static void Main()
	{
		// tableau alétoire de 10 cases dont seules les 5 premières sont initialisées
		int[] tab = {1, 2, 3, 7, 9, 0, 0, 0, 0, 0};
		AfficherChaine("Tableau initialisé et trié (5 premières valeurs).");
		AfficherTableau(tab);
		// insertion de 5 (indice = 3)
		int indice_insertion_valeur = IndiceInsertionPartiellementTrie(tab, 5, 5);
		AfficherChaine("La valeur " + 5 + " est à insérer à l'indice " + indice_insertion_valeur + ".");
		InsertionPartiellementTrie(tab, 5, indice_insertion_valeur, 5);
		AfficherTableau(tab);
		// insertion de 8 (indice = 5)
		indice_insertion_valeur = IndiceInsertionPartiellementTrie(tab, 6, 8);
		AfficherChaine("La valeur " + 8 + " est à insérer à l'indice " + indice_insertion_valeur + ".");
		InsertionPartiellementTrie(tab, 6, indice_insertion_valeur, 8);
		AfficherTableau(tab);
	}
}
